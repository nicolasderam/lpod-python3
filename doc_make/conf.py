# -*- coding: utf-8 -*-
#
# LPOD documentation build configuration file, created by
# sphinx-quickstart on Thu Mar  5 09:42:12 2009.
#
...
# LPOD must be installed on executed python
try:
    import lpod
except ImportError:
...
version = lpod.__version__.split('-')[0]
# The full version, including alpha/beta/rc tags.
release = lpod.__version__
...
html_title = "%s (version: %s) documentation" %(project, version)
...
html_static_path = ['static_in']

# If not '', a 'Last updated on:' timestamp is inserted at every page bottom,
# using the given strftime format.
html_last_updated_fmt = 'Last release: lpOD %s. Last modified: %s.' % (
                        release,
...
htmlhelp_basename = 'lpod-python-doc'
...
# Options for autogenerated documentation
